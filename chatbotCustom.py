...
def answer_question(
    ...
    try:
        ...
        response = openai.Completion.create(
            prompt=f"ADD SPECIFIC PROMPT BUILDING INFO HERE Answer the question based on the context below, if applicable include prices dates etc, and if the question can't be answered based on the context, say \"I don't know\"\n\nContext: {context}\n\n---\n\nQuestion: {question}\nAnswer:",
            temperature=0,
